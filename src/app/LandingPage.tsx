...
export default function LandingPage({ productCount, categoryCount }: LandingPageProps) {
      ...
      <section className="px-6 py-8">
        <div className="max-w-md mx-auto flex justify-center gap-12">
          <div className="text-center">
            <p className="text-3xl md:text-4xl font-bold text-brand-dark">{categoryCount}</p>
